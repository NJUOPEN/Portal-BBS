...
create table PostOfUsers(PostID int NOT NULL AUTO_INCREMENT,IDofUsers int,Time varchar(20),IfFollow int(1),Title varchar(100),PostAdd text,FollowNum smallint,FollowAdd int,primary key(PostID));
