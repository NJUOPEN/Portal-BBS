...
create table PostOfUsers(PostID int NOT NULL AUTO_INCREMENT,IDofUsers int,Time varchar(20),IfFollow int(1),PostAdd text,FellowNum smallint,FellowAdd int,primary key(PostID));
